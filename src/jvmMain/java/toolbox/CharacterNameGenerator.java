...
// from https://github.com/FAForever/gw-backend/blob/develop/src/main/java/com/faforever/gw/services/generator/CharacterNameGenerator.java
public class CharacterNameGenerator {
    ...
    public String generateName(Faction faction) {
        String name = switch (faction) {
            case UEF -> generateUefName();
            case CYBRAN -> generateCybranName();
            case AEON -> generateAeonName();
            case SERAPHIM -> generateSeraphimName() + "-" + generateSeraphimName();
        };

        if(findString(name, blacklistNames)) {
    ...
    private String generateUefName() {
    ...
    private String generateCybranName() {
    ...
    private String generateAeonName() {
    ...
    public static String generateSeraphimName() {
        String str = "";
    ...
    public List<String> generateNames(Faction faction, int count) {
        return IntStream.range(0, count)
                .mapToObj(i -> generateName(faction))
                .toList();
    }
}
